...
if __name__ == "__main__":
    ...
    for f in (glob.glob(build_dir + "/**/*.vo", recursive=True) + glob.glob(build_dir + "/*.vo", recursive=True) + glob.glob(build_dir + "/**/*.glob", recursive=True) + glob.glob(build_dir + "/*.glob", recursive=True)):
